...
Payments/
  ...
  Fisc/FiscOptions.cs          ← 財金 WEBPOS 設定（ActionUrl/商店代號/ApiBaseUrl/StoreSuccessUrl/AdminSuccessUrl）。前台+後台回呼網址（AuthResUrl/AdminAuthResUrl）由 ApiBaseUrl 程式導出（單一來源，避免重複）
