...
public interface IInvoiceService
{
    ...
    Task<Result<InvoiceResult>> VoidAsync(string invoiceNumber, string merchantOrderNo, string buyerName, string? buyerUbn, int totalAmt, string reason, CancellationToken ct = default);
}
