    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/scripts/smartadmin").Include(
                ...
                "~/scripts/plugin/summernote/summernote-image-attributes.js",
                "~/scripts/plugin/summernote/zh-TW.js",
                "~/scripts/plugin/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js",
                "~/scripts/app.min.js"
                ));
